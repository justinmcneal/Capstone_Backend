...
class ConsentService:
    ...
    def record_consent(user_id, user_type, data_consent, ai_consent, ip_address=''):
        ...
        if existing:
            ...
            existing.save()
            logger.info(f"Updated consent for user {user_id}: data={data_consent}, ai={ai_consent}")
            return existing
        ...
        consent.save()
        logger.info(f"Recorded consent for user {user_id}: data={data_consent}, ai={ai_consent}")
    ...
    def update_consent(user_id, user_type, updates, ip_address=''):
        ...
        if 'data_consent' in updates:
            ...
            if old_value != consent.data_consent:
                changes['data_consent'] = {'from': old_value, 'to': consent.data_consent}
