...
urlpatterns = [
    ...
    path("2fa/recovery/request/", TwoFactorRecoveryRequestView.as_view(), name="2fa-recovery-request"),
    path("2fa/recovery/verify/", TwoFactorRecoveryVerifyView.as_view(), name="2fa-recovery-verify"),
    ...
    path("admin/customers/", CustomerManagementView.as_view(), name="admin-customers"),
    path("admin/customers/2fa-recovery/", TwoFactorRecoveryAdminView.as_view(), name="admin-customer-2fa-recovery-list"),
    path("admin/customers/<str:customer_id>/", CustomerDetailView.as_view(), name="admin-customer-detail"),
    path("admin/customers/<str:customer_id>/unlock/", CustomerUnlockView.as_view(), name="admin-customer-unlock"),
    path("admin/customers/<str:customer_id>/deletion/finalize/", CustomerDeletionFinalizeView.as_view(), name="admin-customer-deletion-finalize"),
    path("admin/customers/<str:customer_id>/2fa-recovery/", TwoFactorRecoveryAdminView.as_view(), name="admin-customer-2fa-recovery-decision"),
