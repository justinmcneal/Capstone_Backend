...
AI_ASSISTANT_STREAM_MAX_CHARS = int(
    os.getenv('AI_ASSISTANT_STREAM_MAX_CHARS') or '32768'
)
AI_ASSISTANT_STREAM_MAX_BYTES = int(
    os.getenv('AI_ASSISTANT_STREAM_MAX_BYTES') or '131072'
)
AI_ASSISTANT_STREAM_MAX_DURATION_SECONDS = float(
    os.getenv('AI_ASSISTANT_STREAM_MAX_DURATION_SECONDS') or '120'
)
...
_ai_integer_bounds = {
    ...
    'AI_ASSISTANT_STREAM_MAX_CHARS': (1, 200000),
    'AI_ASSISTANT_STREAM_MAX_BYTES': (1, 800000),
